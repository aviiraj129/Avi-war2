...
x====The Speed Royal Hunter BR9HM9N B0II AVII-X'wd====x

\033[91;1m[[ AUTHOR NAME ]]       BR9HM9N B0II AVII-X'wd====x
...
print ("[-[ TH3 T00L CREATE BY  BR9HM9N B0II AVII ]-]")
...
while True:
    for line in lines:
        if len(line) > 0:
            ...
            print('KOII DIKKAT NHI HAI COMMENT GAYA - ', line)
            print("\033[91;1m")
            count += 1
            if count % 50 == 0:
            	sleep(1)
